...
4. \`!whois <mention/snowflake>\` - Retrieves the Roblox username, ID, and profile of the specified Discord user.
    • Argument must be EITHER a mention of the user OR the Discord user ID of the user.
...
3. \`!accept <username>\` - Accepts \`username\`'s application, accepting them into the respective group and marking the application as processed.
